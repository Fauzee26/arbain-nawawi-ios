...
class Hadis1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        let pathAudio = NSURL.fileURL(withPath: Bundle.main.path(forResource: "nawawi01", ofType: "mp3")!)
