...
import AVKit
import AVFoundation
class hadis10ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad()
        let pathAudio = NSURL.fileURL(withPath: Bundle.main.path(forResource: "nawawi10", ofType: "mp3")!)
